...
## Interactive challenge hub

Use this interactive quiz board to make learning more playful:

- Module Roadmap with progressive unlock path
- Personalized Study Plan based on weak areas and missing milestones
- Quiz Arena for module mastery challenges
- Reading Missions tied to extracted additional-reading references
- Learning Quests and role-based Scenario Mode
...
<div id="interactive-training-app"></div>
